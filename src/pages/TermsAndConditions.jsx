...
const TermsAndConditions = () => {
  ...
  return (
    <div className="w-full px-4 md:px-8 xl:px-20 py-6">
      ...
      <h1 className="font-bold text-4xl my-6">Terms and Conditions</h1>

      <div className="w-full flex flex-col items-start gap-4">
        <p>Agreement between User and www.Markettoll.com</p>
        <p>
        ...
        <Link to="https://www.Markettoll.com">
        ...
        <p>
          Visiting{" "}
          <Link to={"https://www.Markettoll.com"}>www.Markettoll.com</Link> or
          sending emails to MarketToll constitutes electronic communications.
        ...
        <p>
          ...
          us at info@marketplace.com with any questions.
        </p>

        <h2>Links to Third Party Sites/Third Party Services</h2>
        <p>
          <Link to="https://www.Markettoll.com">www.Markettoll.com</Link> may
          contain links to other websites ("Linked Sites"). The Linked Sites are
        ...
        <p>
          ...
          <Link to="https://www.Markettoll.com">www.Markettoll.com</Link> are
          delivered by third party sites and organizations. By using any
          product, service or functionality originating from the{" "}
          <Link to="https://www.Markettoll.com">www.Markettoll.com</Link>{" "}
          ...
          <Link to="https://www.Markettoll.com">www.Markettoll.com</Link> users
          and customers.
        </p>
