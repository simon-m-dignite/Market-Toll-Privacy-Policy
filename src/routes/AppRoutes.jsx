...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      />
      <Route path="/verify-otp" element={<Layout page={<VerifyOtpPage />} />} />
      <Route
      ...
      <Route path="/boost-post" element={<Layout page={<BoostPostPage />} />} />
      ...
      <Route
        ...
        element={
          <Layout page={<SettingsPage page={<SettingsAddressEditPage />} />} />
        }
      />
      <Route
      ...
      <Route
        ...
        element={<Layout page={<SettingsPage page={<EmailSupportPage />} />} />}
      />
      <Route
